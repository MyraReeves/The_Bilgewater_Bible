    ...
    return (
        <main>
            <div className="greeting">
                <h2>Welcome to Governor Featherstone&apos;s Complete and Accurate, Totally Fictional <br/>Journal of Who&apos;s Who in Nassau Town Circa 1715!</h2> 
                <p>Here-in lies an account of flibustiers, buccaneers, freebooters, privateers, maroons, and the occassional termagant. <br/> Dis ting go with sense and keep yer wits about ye. For there is no peace beyond the line!</p>
            </div>
