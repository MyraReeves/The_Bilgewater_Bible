...
function LearnMore() {
    ...
    const checkForSelection = () => {
        ...
        if (selection == 'notoriousPirates'){
            return <div className="box-shadow"> <LibraryOfCongressAPI referenceURL = 'resource/rbc0001.2019gen31667/?st=gallery&c=160'/> </div>
        }
        ...
        if (selection == 'pirateCaptains'){
            return <div className="box-shadow"> <LibraryOfCongressAPI referenceURL = 'resource/gdcmassbookdig.historyofpirates01care/?st=gallery&c=160'/> </div>
        }
        ...
        if (selection == 'piratesOwn'){
            return <div className="box-shadow"> <LibraryOfCongressAPI referenceURL= 'resource/gdcmassbookdig.piratesownbook00ellm_0/?st=gallery&c=160' /> </div>
        }
        ...
        if (selection == 'ravagedSeas'){
            return <div className="box-shadow"> <LibraryOfCongressAPI referenceURL= 'resource/gdcmassbookdig.captainwilliamki01abbo/?st=gallery&c=160' /> </div>
        }
        ...
        if (selection == 'britishPrivateer'){
            return <div className="box-shadow"> <LibraryOfCongressAPI referenceURL='resource/gdcscd.00413141047/?st=gallery&c=160' /></div>
        }
        ...
        if (selection == 'buccaneersThesis'){
            return <div className="box-shadow"> <LibraryOfCongressAPI referenceURL= 'resource/gdcmassbookdig.buccaneersinwest00hari/?st=gallery&c=160' /> </div>
        }
